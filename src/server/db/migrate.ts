...
/**
 * Aplica as migrations de src/server/db/migrations, em ordem, uma por
 * transação (DDL é transacional no Postgres). Idempotente: registra cada
 * arquivo já aplicado numa tabela de controle e pula o que já rodou — é o
 * que permite chamar isto a cada deploy sem recriar nada.
 */
async function main() {
